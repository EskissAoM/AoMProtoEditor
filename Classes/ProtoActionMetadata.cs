...
public static class ProtoActionMetadataCatalog
{
    ...
    private static readonly Dictionary<string, ProtoActionFieldDefinition> Definitions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["minrate"] = new("minrate", "Min Rate", ProtoActionFieldEditorKind.StructuredList, true, ["type", "resource"]),
    ...
    private static readonly Dictionary<string, ProtoActionFieldDefinition> SupplementalDefinitions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["forbidabstracttype"] = new("forbidabstracttype", "Forbid Abstract Type", ProtoActionFieldEditorKind.StructuredList, true),
        ["forbidunittype"] = new("forbidunittype", "Forbid Unit Type", ProtoActionFieldEditorKind.StructuredList, true),
    ...
    private static readonly Dictionary<string, ProtoActionTypeEditorProfile> EditorProfiles = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Build"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "maxrange", "rate"],
        ...
        ["BurstHeal"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "maxrange", "rof", "rate"],
        ...
        ["DevoteMajor"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "devotiontime", "maxrange"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase)),
        ["DevoteMinor"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "maxrange", "devotioncombatxpreward", "devotionfavorreward", "devotiontime", "rate", "reductionstart", "reductionend", "minscale", "soundsetenter", "devotionpower", "devotionfavortrickle", "devotionhealthdraineachsecond", "devotionhealthdrainlimit", "devotionscaleatminimumhealth"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase)),
        ...
        ["Eat"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["maxrange", "rate"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase)),
        ["SwitchTactic"] = new ProtoActionTypeEditorProfile(
        ...
        ["Heal"] = new ProtoActionTypeEditorProfile(
            ...
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase)),
        ["ConditionalShield"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["maxrange", "rof", "shieldpoints", "shielddecayrate", "maximumduration", "modifytargetlimit", "damage", "damagebonus", "rate", "slowhealmultiplier", "modelattachment", "modelattachmentbone", "targetattachment", "targetattachmentbone"],
            HiddenByDefaultTags: new HashSet<string>(StringComparer.OrdinalIgnoreCase),
        ...
        ["AutoBoost"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "maxrange", "rof", "rate", "damage"],
            HiddenByDefaultTags: new HashSet<string>(["damagebonus"], StringComparer.OrdinalIgnoreCase),
        ...
        ["AutoRangedModify"] = new ProtoActionTypeEditorProfile(
            ...
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase),
            DefaultFlagTags: ["persistent"]),
        ["AreaMutate"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["maxrange", "modifyabstracttype", "forbidabstracttype", "modifyprotoid", "forbidunittype"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus", "rate"], StringComparer.OrdinalIgnoreCase),
            DefaultFlagTags: ["persistent"]),
        ["AutoRangedAttach"] = new ProtoActionTypeEditorProfile(
        ...
        ["AreaStealth"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["maxrange", "rate"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase),
            DefaultFlagTags: ["persistent"]),
        ...
        ["WaterTornado"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["maxrange", "maxspread", "spreadfactor"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus", "rate"], StringComparer.OrdinalIgnoreCase),
            DefaultFlagTags: ["persistent"]),
        ...
        ["Bolster"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["anim", "maxrange", "rate", "projectile"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "damage", "damagebonus"], StringComparer.OrdinalIgnoreCase),
            DefaultFlagTags: ["attackaction"]),
        ["Rampage"] = new ProtoActionTypeEditorProfile(
            DefaultVisibleTags: ["autocastdistance", "modifyduration", "damage", "rate"],
            HiddenByDefaultTags: new HashSet<string>(["rof", "maxrange", "damagebonus"], StringComparer.OrdinalIgnoreCase),
